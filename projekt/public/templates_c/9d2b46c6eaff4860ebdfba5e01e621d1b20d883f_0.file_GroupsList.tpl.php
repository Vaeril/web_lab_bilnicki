...
">    <?php echo $_smarty_tpl->getValue('r')["name"];?>
   ...
   </p></div><div class="col-sm-7"><?php ob_start();
echo $_smarty_tpl->getValue('r')['owner'];
$_prefixVariable1 = ob_get_clean();
if (($_prefixVariable1 == \core\SessionUtils::load("id",true))) {?><div class="explore-map-icon"><a href="<?php echo $_smarty_tpl->getValue('conf')->action_url;?>
editGroup/<?php echo $_smarty_tpl->getValue('r')['id'];?>
"><i data-feather="edit-2"></i></a></div><?php }?></div></div></div></div></div></div>
            <?php
}
