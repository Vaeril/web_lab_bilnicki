...
class ConverterCtrl{
    ...
    function putInDatabase() {
			...
			try {
                ...
                getDB()->insert("conversion", [
                    "input" => $this->form->input,
                    "inputType" => $this->form->input_type,
                    "binaryResult" => $this->result->results[0],
                    "decimalResult" => $this->result->results[1],
                    "hexResult" => $this->result->results[2]
                ]);
